...
(9, 'Sting Vàng Chai 330ml', '<p>Nước uống tăng lực</p>', 10000, 20, 2, 'http://localhost/Store/uploads/nuoc-sting-vang-320ml.jpg', '', 1);
...
--
ALTER TABLE `lichsunhap`
  MODIFY `MaLichSuNhap` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
